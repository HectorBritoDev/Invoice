...
class CreateSenderGuidesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sender_guides', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('driver_ruc')->nullable();
            $table->string('payer_dni')->nullable();
            $table->string('payer_ruc')->nullable();
    ...
    {
        Schema::dropIfExists('sender_guides');
    }
}
