...
class CreateCreditNoteConfigurationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('credit_note_configurations', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('credit_note_configurations');
    }
}
