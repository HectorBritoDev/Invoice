...
<html lang="en">
    ...
    <head>
        ...
        <title>Nota de crédito {{ $creditNote->serie }} - {{ $creditNote->code }}</title>
    </head>
    ...
    <body>
        ...
        <div class="mt-4">
            <div class="">
                <label> <strong>Señores:</strong> {{ $creditNote->client_name }}</label>
            </div>

            <div class="mt-1">
                <label>{{ $creditNote->note }}</label>
            </div>
        </div>

        <h4> Nota de crédito {{ $creditNote->serie }}-{{ $creditNote->code }}</h4>
        ...
        <div class="mt-4">
            ...
            <div class="">
                {{-- <label> <strong>Forma de pago: </strong>{{ $creditNote->condition }}
                días</label>
