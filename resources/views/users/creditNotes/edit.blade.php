                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group">
                            <button class="btn btn-link" id="searchCreditNoteIcon" data-target="#searchCreditNoteModal"
                        ...
                        <div class="d-flex col-md-1">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuConfiguration">
                                    ...
                                    <form action="{{ route('creditNote.update',$creditNote) }}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="serie" class="form-control ml-4" value="{{ $creditNote->serie }}"
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="code" class="form-control ml-4" value="{{ $creditNotes->where('serie',$creditNote->serie)->min('code') }}"
                                                    style="width:70%;" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <form action="{{ route('creditNote.config',$configuration) }}" method="POST" class="ml-2">
                                        @csrf
                                        @method('PUT')

                                        <input type="hidden" name="credit_note_id" id="" value="{{ $creditNote->id }}">
                    ...
                    <table class="table table-hover" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->total }}</td>
                                <td>
                                    <form id="itemForm{{ $item->id }}" action="{{ route('creditNoteItem.destroy',$item) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('creditNoteItem.update',$item) }}" method="POST">
                                                @csrf
                                                @method('PUT')
...
$('#option{{ $item->id }}').html(option_html);
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <form action="{{ route('creditNote.destroy.items',$creditNote) }}" method="POST" id="destroyAllItemsForm">
                                @csrf
                                @method('DELETE')
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-md-5">
                        @if ($creditNote->status == null && $creditNote->items()->count() > 0 )
                    ...
                    <div class="col-md-2">
                        ...
                        'aprobada' || $creditNote->status == 'guardada') &&
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('creditNoteItem.store','beforeTicket') }}" method="POST">
                    @else
                    <form action="{{ route('creditNoteItem.store') }}" method="POST">
                        @endif
                        @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('creditNote.update',$creditNote) }}" method="POST">
                    ...
                    @method('PUT')
                    <div class="row form-group">
                        <textarea name="note" class="form-control ml-3 mr-3">{{ $creditNote->note }}</textarea>
                    </div>
                    <button type="submit" class="form-control btn btn-primary mt-2">Aceptar</button>
                </form>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('creditNote.update',$creditNote) }}" method="POST">
                    ...
                    @method('PUT')
                    <div class="row form-group">
                        <input name="detraction_account" class="form-control ml-3 mr-3" value="{{ $creditNote->detraction_account }}">
                    </div>
                    <button type="submit" class="form-control btn btn-primary mt-2">Aceptar</button>
                </form>
            </div>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('creditNote.update',$creditNote) }}" method="POST">
                    ...
                    <div class="row form-group">
                        ...
                        <textarea name="internal_message" class="form-control ml-3 mr-3">{{ $creditNote->internal_message }}</textarea>
                    </div>
                    <button type="submit" class="form-control btn btn-primary mt-2">Aceptar</button>
                </form>
            </div>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('creditNote.update',$creditNote) }}" method="POST">
                    ...
                    <div class="row">
                        {{-- <textarea name="internal_message" class="form-control ml-3 mr-3">{{ $creditNote->internal_message }}</textarea>
                        --}}
                        {{-- <textarea name="bank_account" class="form-control ml-3 mr-3"> {{ $creditNote->bank_account }}</textarea>
                        --}}
                        <div class="form-group col-md-12">

                            <select name="bank_account" id="bank_accout" class="form-control">
                                <option value="{{ $creditNote->bank_account }}">{{ $creditNote->bank_account }}</option>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('creditNote.update',$creditNote) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
...
<!--COPY invoice Modal -->
<div class="modal fade" id="searchCreditNoteModal" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <form action="{{ route('creditNote.copy',$creditNote) }}" method="POST" id="searchBudgetForm">
                            @csrf
                            @method('PUT')
