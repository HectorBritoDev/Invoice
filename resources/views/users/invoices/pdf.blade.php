...
<html lang="en">
    ...
    <head>
        ...
        <title>Factura { $invoice->serie }}-{{ $invoice->code }}</title>
    </head>
    ...
    <body>
        ...
        <div class="mt-4">
            <div class="">
                <label> <strong>Señores:</strong> {{ $invoice->client_name }}</label>
            </div>
        ...
        <h4> Factura {{ $invoice->serie }}-{{ $invoice->code }}</h4>
        ...
        <div class="mt-4">
            ...
            <div class="">
                <label> <strong>Forma de pago: </strong>{{ $invoice->condition }}
                    días</label>
