                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group">
                            <button class="btn btn-link" id="searchinvoiceIcon" data-target="#searchinvoiceModal"
                        ...
                        <div class="d-flex col-md-1">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuConfiguration">
                                    ...
                                    <form action="{{ route('invoice.update',$invoice) }}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="serie" class="form-control ml-4" value="{{ $invoice->serie }}"
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="code" class="form-control ml-4" value="{{ $invoices->where('serie',$invoice->serie)->min('code') }}"
                                                    style="width:70%;" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <form action="{{ route('invoice.config',$configuration) }}" method="POST" class="ml-2">
                                        @csrf
                                        @method('PUT')

                                        <input type="hidden" name="invoice_id" id="" value="{{ $invoice->id }}">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="emission_date" id="emission_date" class="form-control-plaintext"
                                placeholder="Fecha de emision" value="{{ $invoice->formatted_emission_date }}" readonly>
                        ...
                        <div class=" form-group col-md-3">
                            ...
                            <input type="text" name="condition" id="condition" class="form-control-plaintext"
                                placeholder="Fecha de emision" value="{{ $invoice->condition }} días" readonly>
                    ...
                    <table class="table table-hover" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->total }}</td>
                                <td>
                                    <form id="itemForm{{ $item->id }}" action="{{ route('invoiceItem.destroy',$item) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('invoiceItem.update',$item) }}" method="POST">
                                                @csrf
                                                @method('PUT')
...
$('#option{{ $item->id }}').html(option_html);
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <form action="{{ route('invoice.destroy.items',$invoice) }}" method="POST" id="destroyAllItemsForm">
                                @csrf
                                @method('DELETE')
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-md-5">
                        @if ($invoice->status == null && $invoice->items()->count() > 0 )
                    ...
                    <div class="col-md-2">
                        ...
                        'aprobada' || $invoice->status == 'guardada') &&
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('invoiceItem.store','beforeInvoice') }}" method="POST">
                    @else
 ...
 <div class="row">
            ...
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input type="number" name="sub_total" id="sub_total" class="form-control-plaintext" placeholder="Sub Total"
                        required min="1" readonly>
                </div>
                <div class="col-md-4">
                    <label for="">IGV</label>
                    <input type="number" name="tax" id="tax" class="form-control-plaintext" placeholder="Impuesto" min="1"
                        required readonly>
                </div>
                <div class="form-group col-md-4">
                    <label for="">Total</label>
                    <input type="number" name="total" id="total" class="form-control-plaintext" placeholder="Total" min="1"
                        required readonly>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('invoice.update',$invoice) }}" method="POST">
                    ...
                    @method('PUT')
                    <div class="row form-group">
                        <textarea name="note" class="form-control ml-3 mr-3">{{ $invoice->note }}</textarea>
                    </div>
                    <button type="submit" class="form-control btn btn-primary mt-2">Aceptar</button>
                </form>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('invoice.update',$invoice) }}" method="POST">
                    ...
                    @method('PUT')
                    <div class="row form-group">
                        <input name="detraction_account" class="form-control ml-3 mr-3" value="{{ $invoice->detraction_account }}">
                    </div>
                    <button type="submit" class="form-control btn btn-primary mt-2">Aceptar</button>
                </form>
            </div>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('invoice.update',$invoice) }}" method="POST">
                    ...
                    <div class="row form-group">
                        ...
                        <textarea name="internal_message" class="form-control ml-3 mr-3">{{ $invoice->internal_message }}</textarea>
                    </div>
                    <button type="submit" class="form-control btn btn-primary mt-2">Aceptar</button>
                </form>
            </div>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('invoice.update',$invoice) }}" method="POST">
                    ...
                    <div class="row">
                        {{-- <textarea name="internal_message" class="form-control ml-3 mr-3">{{ $invoice->internal_message }}</textarea>
                        --}}
                        {{-- <textarea name="bank_account" class="form-control ml-3 mr-3"> {{ $invoice->bank_account }}</textarea>
                        --}}
                        <div class="form-group col-md-12">

                            <select name="bank_account" id="bank_accout" class="form-control">
                                <option value="{{ $invoice->bank_account }}">{{ $invoice->bank_account }}</option>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('invoice.update',$invoice) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
...
<!--COPY invoice Modal -->
<div class="modal fade" id="searchinvoiceModal" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <form action="{{ route('invoice.copy',$invoice) }}" method="POST" id="searchBudgetForm">
                            @csrf
                            @method('PUT')
