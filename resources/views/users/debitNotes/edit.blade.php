                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group">
                            <button class="btn btn-link" id="searchDebitNoteIcon" data-target="#searchDebitNoteModal"
                                data-toggle="modal"><i class="fas fa-search"></i></button>
                            <h3><strong>Nota de débito {{ $debitNote->serie }} - {{ $debitNote->code }}</strong></h3>
                        </div>
                        ...
                        <div class="d-flex col-md-1">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuConfiguration">
                                    ...
                                    <form action="{{ route('debitNote.update',$debitNote) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="serie" class="form-control ml-4" value="{{ $debitNote->serie }}"
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="code" class="form-control ml-4" value="{{ $debitNotes->where('serie',$debitNote->serie)->min('code') }}"
                                                    style="width:70%;" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <form action="{{ route('debitNote.config',$configuration) }}" method="POST" class="ml-2">
                                        @csrf
                                        @method('PUT')

                                        <input type="hidden" name="debit_note_id" id="" value="{{ $debitNote->id }}">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="client_email" id="client_email" class="form-control-plaintext"
                                placeholder="Email" value="{{ $debitNote->client_email }}" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="client_main_adress" id="client_adress" class="form-control-plaintext"
                                placeholder="Direccion" value="{{ $debitNote->client_main_adress }}" readonly>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" name="emission_date" id="emission_date" class="form-control-plaintext"
                                placeholder="Fecha de emision" value="{{ $debitNote->formatted_emission_date }}"
                                readonly>
                        ...
                        <div class=" form-group col-md-2">
                            ...
                            @if ($debitNote->invoice != null)

                            <input type="text" name="condition" id="condition" class="form-control-plaintext"
                                placeholder="Fecha de emision" value="{{ $debitNote->invoice->serie }} - {{ $debitNote->invoice->code }}"
                                readonly>
                            @else
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="reason" id="reason" class="form-control-plaintext" placeholder="Fecha de emision"
                                value="{{ $debitNote->reason }}" readonly>
                        </div>
                    ...
                    <table class="table table-hover" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->total }}</td>
                                <td>
                                    <form id="itemForm{{ $item->id }}" action="{{ route('debitNoteItem.destroy',$item) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('debitNoteItem.update',$item) }}" method="POST">
                                                @csrf
                                                @method('PUT')
...
$('#option{{ $item->id }}').html(option_html);
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <form action="{{ route('debitNote.destroy.items',$debitNote) }}" method="POST" id="destroyAllItemsForm">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="row mt-3">
                        <div class="form-group col-md-5">
                            ...
                            <a href="{{ asset('files/'.auth()->user()->id.'/debitNotes/'. $debitNote->file) }}">
                                Ver Archivo
                            </a>
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-md-5">
                        @if ($debitNote->status == null && $debitNote->items()->count() > 0 )
                    ...
                    <div class="col-md-2">
                        @if (($debitNote->status == null || $debitNote->status == 'emitida' || $debitNote->status ==
                        'aprobada' || $debitNote->status == 'guardada') &&
                        $debitNote->items()->count() > 0 )
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('debitNoteItem.store','beforeTicket') }}" method="POST">
                    @else
                    <form action="{{ route('debitNoteItem.store') }}" method="POST">
                        @endif
                        @csrf
                        <input type="hidden" name="debit_note_id" id="debit_note_id" value="{{ $debitNote->id }}">
                        <div class="row">
                            <div class="form-group col-md-12">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('debitNote.update',$debitNote) }}" method="POST">
                    ...
                    @method('PUT')
                    <div class="row form-group">
                        <textarea name="note" class="form-control ml-3 mr-3">{{ $debitNote->note }}</textarea>
                    </div>
                    <button type="submit" class="form-control btn btn-primary mt-2">Aceptar</button>
                </form>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('debitNote.update',$debitNote) }}" method="POST">
                    ...
                    @method('PUT')
                    <div class="row form-group">
                        <input name="detraction_account" class="form-control ml-3 mr-3" value="{{ $debitNote->detraction_account }}">
                    </div>
                    <button type="submit" class="form-control btn btn-primary mt-2">Aceptar</button>
                </form>
            </div>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('debitNote.update',$debitNote) }}" method="POST">
                    ...
                    <div class="row form-group">
                        ...
                        <textarea name="internal_message" class="form-control ml-3 mr-3">{{ $debitNote->internal_message }}</textarea>
                    </div>
                    <button type="submit" class="form-control btn btn-primary mt-2">Aceptar</button>
                </form>
            </div>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('debitNote.update',$debitNote) }}" method="POST">
                    ...
                    <div class="row">
                        {{-- <textarea name="internal_message" class="form-control ml-3 mr-3">{{ $debitNote->internal_message }}</textarea>
                        --}}
                        {{-- <textarea name="bank_account" class="form-control ml-3 mr-3"> {{ $debitNote->bank_account }}</textarea>
                        --}}
                        <div class="form-group col-md-12">

                            <select name="bank_account" id="bank_accout" class="form-control">
                                <option value="{{ $debitNote->bank_account }}">{{ $debitNote->bank_account }}</option>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('debitNote.update',$debitNote) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
...
<!--COPY invoice Modal -->
<div class="modal fade" id="searchDebitNoteModal" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <form action="{{ route('debitNote.copy',$debitNote) }}" method="POST" id="searchBudgetForm">
                            @csrf
                            @method('PUT')
