            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <a href="{{ route('debitNote.view.pdf',$debitNote) }}">
                            <button class="btn btn-primary">
                    ...
                    <div class="col-md-2">
                        @if ($debitNote->status == 'emitida' || $debitNote->status =="aprobada" || $debitNote->status
                        =="guardada" || $debitNote->status
                        =="facturada" )

                        {{-- <a href="{{ url('pdf/invoice/'.$debitNote->id.'/view?withBankAccount') }}"> --}}

                        <a href="{{ route('debitNote.mail',$debitNote) }}">
                            <button class="btn btn-primary">
                                Enviar por correo
                            </button>
                        </a>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <a href="{{ url('mail/invoice/'.$debitNote->id.'?withBankAccount') }}">
                            <button class="btn btn-primary">Con cuentas bancarias</button>
                        </a>
