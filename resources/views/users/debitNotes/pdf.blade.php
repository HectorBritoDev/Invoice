...
<html lang="en">
    ...
    <head>
        ...
        <title>Nota de débito {{ $debitNote->serie }} - {{ $debitNote->code }}</title>
    </head>
    ...
    <body>
        ...
        <div class="mt-4">
            <div class="">
                <label> <strong>Señores:</strong> {{ $debitNote->client_name }}</label>
            </div>

            <div class="mt-1">
                <label>{{ $debitNote->note }}</label>
            </div>
        </div>

        <h4> Nota de débito {{ $debitNote->serie }}-{{ $debitNote->code }}</h4>
        ...
        <div class="mt-4">
            ...
            <div class="">
                {{-- <label> <strong>Forma de pago: </strong>{{ $debitNote->condition }}
                días</label>
