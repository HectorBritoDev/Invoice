...
<html lang="en">
    ...
    <head>
        ...
        <title>Boleta {{ $ticket->serie }} - {{ $ticket->code }}</title>
    </head>
    ...
    <body>
        ...
        <div class="mt-4">
            <div class="">
                <label> <strong>Señores:</strong> {{ $ticket->client_name }}</label>
            </div>
        ...
        <h4> Boleta {{ $ticket->serie }}-{{ $ticket->code }}</h4>
        ...
        <div class="mt-4">
            ...
            <div class="">
                <label> <strong>Forma de pago: </strong>{{ $ticket->condition }}
                    días</label>
