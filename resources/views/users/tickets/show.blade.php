                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="emission_date" id="emission_date" class="form-control-plaintext"
                                ...
                                value="{{ $ticket->formatted_emission_date }}">
                        ...
                        <div class=" form-group col-md-3">
                            ...
                            <input type="text" name="condition" id="condition" class="form-control-plaintext"
                                placeholder="Fecha de emision" value="{{ $ticket->condition }}" readonly>
                    ...
                    <div class="row mt-3">
                        <div class="form-group col-md-5">
                            ...
                            <a href="{{ asset('files/'.auth()->user()->id.'/tickets/'. $ticket->file) }}">
                                Ver Archivo
                            </a>
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <a href="{{ route('ticket.view.pdf',$ticket) }}">
                            <button class="btn btn-primary">
                    ...
                    <div class="col-md-2">
                        @if ($ticket->status == 'emitida' || $ticket->status =="aprobada" || $ticket->status
                        =="guardada" || $ticket->status
                        =="facturada" )

                        {{-- <a href="{{ url('pdf/invoice/'.$ticket->id.'/view?withBankAccount') }}"> --}}

                        <a href="{{ route('ticket.mail',$ticket) }}">
                            <button class="btn btn-primary">
                                Enviar por correo
                            </button>
                        </a>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <a href="{{ url('mail/invoice/'.$ticket->id.'?withBankAccount') }}">
                            <button class="btn btn-primary">Con cuentas bancarias</button>
                        </a>
