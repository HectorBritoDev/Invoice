                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group">
                            <button class="btn btn-link" id="searchticketIcon" data-target="#searchticketModal"
                                data-toggle="modal"><i class="fas fa-search"></i></button>
                            <h3><strong>Boleta {{ $ticket->serie }} - {{ $ticket->code }}</strong></h3>
                        </div>
                        ...
                        <div class="d-flex col-md-1">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuConfiguration">
                                    ...
                                    <form action="{{ route('ticket.update',$ticket) }}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="serie" class="form-control ml-4" value="{{ $ticket->serie }}"
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="code" class="form-control ml-4" value="{{ $tickets->where('serie',$ticket->serie)->min('code') }}"
                                                    style="width:70%;" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <form action="{{ route('ticket.config',$configuration) }}" method="POST" class="ml-2">
                                        @csrf
                                        @method('PUT')

                                        <input type="hidden" name="ticket_id" id="" value="{{ $ticket->id }}">
                    ...
                    <div class="row mt-4">
                        <div class="form-group  col-md-6 ">
                            ...
                            <input type="text" name="client_name" id="ruc" class="form-control-plaintext" placeholder="RUC"
                                value="{{ $ticket->client_name }}" readonly>
                        ...
                        <div class="form-group col-md-3 form-inline">
                            ...
                            <input type="text" name="ruc" id="ruc" class="form-control-plaintext" placeholder="RUC"
                                value="{{ $ticket->ruc }}" readonly>
                            @else
                            <label for="ruc">DNI</label>
                            <input type="text" name="ruc" id="ruc" class="form-control-plaintext" placeholder="RUC"
                                value="{{ $ticket->dni }}" readonly>
                            @endif
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="client_email" id="client_email" class="form-control-plaintext"
                                placeholder="Email" value="{{ $ticket->client_email }}" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="client_main_adress" id="client_adress" class="form-control-plaintext"
                                placeholder="Direccion" value="{{ $ticket->client_main_adress }}" readonly>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="emission_date" id="emission_date" class="form-control-plaintext"
                                placeholder="Fecha de emision" value="{{ $ticket->formatted_emission_date }}" readonly>
                        ...
                        <div class=" form-group col-md-3">
                            ...
                            <input type="text" name="condition" id="condition" class="form-control-plaintext"
                                placeholder="Fecha de emision" value="{{ $ticket->condition }} días" readonly>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="expiration_date" id="expiration_date" class="form-control-plaintext"
                                placeholder="Fecha de emision" value="{{ $ticket->formatted_expiration_date }}"
                                readonly>
                    ...
                    <table class="table table-hover" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->total }}</td>
                                <td>
                                    <form id="itemForm{{ $item->id }}" action="{{ route('ticketItem.destroy',$item) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('ticketItem.update',$item) }}" method="POST">
                                                @csrf
                                                @method('PUT')
...
$('#option{{ $item->id }}').html(option_html);
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <form action="{{ route('ticket.destroy.items',$ticket) }}" method="POST" id="destroyAllItemsForm">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="row mt-3">
                        <div class="form-group col-md-5">
                            ...
                            <a href="{{ asset('files/'.auth()->user()->id.'/ticket/'. $ticket->file) }}">
                                Ver Archivo
                            </a>
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-md-5">
                        @if ($ticket->status == null && $ticket->items()->count() > 0 )
                    ...
                    <div class="col-md-2">
                        @if (($ticket->status == null || $ticket->status == 'emitida' || $ticket->status ==
                        'aprobada' || $ticket->status == 'guardada') &&
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('ticketItem.store','beforeTicket') }}" method="POST">
                    @else
                    <form action="{{ route('ticketItem.store') }}" method="POST">
                        @endif
                        @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('ticket.update',$ticket) }}" method="POST">
                    ...
                    @method('PUT')
                    <div class="row form-group">
                        <textarea name="note" class="form-control ml-3 mr-3">{{ $ticket->note }}</textarea>
                    </div>
                    <button type="submit" class="form-control btn btn-primary mt-2">Aceptar</button>
                </form>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('ticket.update',$ticket) }}" method="POST">
                    ...
                    @method('PUT')
                    <div class="row form-group">
                        <input name="detraction_account" class="form-control ml-3 mr-3" value="{{ $ticket->detraction_account }}">
                    </div>
                    <button type="submit" class="form-control btn btn-primary mt-2">Aceptar</button>
                </form>
            </div>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('ticket.update',$ticket) }}" method="POST">
                    ...
                    <div class="row form-group">
                        ...
                        <textarea name="internal_message" class="form-control ml-3 mr-3">{{ $ticket->internal_message }}</textarea>
                    </div>
                    <button type="submit" class="form-control btn btn-primary mt-2">Aceptar</button>
                </form>
            </div>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('ticket.update',$ticket) }}" method="POST">
                    ...
                    <div class="row">
                        {{-- <textarea name="internal_message" class="form-control ml-3 mr-3">{{ $ticket->internal_message }}</textarea>
                        --}}
                        {{-- <textarea name="bank_account" class="form-control ml-3 mr-3"> {{ $ticket->bank_account }}</textarea>
                        --}}
                        <div class="form-group col-md-12">

                            <select name="bank_account" id="bank_accout" class="form-control">
                                <option value="{{ $ticket->bank_account }}">{{ $ticket->bank_account }}</option>
...
<!--COPY invoice Modal -->
<div class="modal fade" id="searchticketModal" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Copiar cotizacion</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <form action="{{ route('ticket.copy',$ticket) }}" method="POST" id="searchBudgetForm">
                            @csrf
                            @method('PUT')
                            <select name="budget_id" id="budget_id" class="form-control select2">
                                ...
                                <option value="{{ $budget->id }}">{{ $budget->serie }}-{{ $budget->code }} , {{ $budget->client_name }},
                                    {{ $budget->formatted_emission_date }}</option>
