...
<html lang="en">
    ...
    <head>
        ...
        <title>Cotización {{ $budget->serie }}-{{ $budget->code }}</title>
    </head>
    ...
    <body>
        ...
        <div class="mt-4">
            <div class="">
                <label> <strong>Señores:</strong> {{ $budget->client_name }}</label>
            </div>
        ...
        <h4> Cotización {{ $budget->serie }}-{{ $budget->code }}</h4>
        ...
        <div class="mt-4">
            ...
            <div class="">
                <label> <strong>Forma de pago: </strong>{{ $budget->condition }}
                    días</label>
